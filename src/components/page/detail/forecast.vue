<template>
  <div class="right1">
    <div class="right-top1">
      <h2 class="h21">数据预测</h2>
      <div class="pp">未来，大数据会变得越来越重要，其核心应用预测也会成为互联网行业以及产业变革的重要力量，我们很有必要对数据预测及其分析方法进行全面且深入的了解。在这一点上，《大数据预测》是本很好的读物，适合大数据所有相关行业的人阅读。</div>
      <ul>
        <li><span>购买数量：</span><plusLess :num="num"></plusLess></li>
        <li><span>媒介：</span><v-selects :type="type"></v-selects></li>
        <li><span>有效时间：</span>一年</li>
        <li><span>总价：</span>500 元</li>
      </ul>
